                    ...
                    <div class="card-body" id="clientsContainer">
                        ...
                        <form method="POST" action="{{route('hotelsReservations.update')}}">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach($unverifiedHotelClients as $client)

                                    <tr>
                                        <input type="hidden" name="reservation_hotel_id" value="{{ $client->id }}">
                                        <td>#{{ $client->user->id }}</td>
                                        <td>
                                            <input type="date" name="check_in_date" value="{{ $client->check_in_date }}">
                                        </td>
                                        <td>
                                            <input type="date" name="check_out_date" value="{{ $client->check_out_date }}">
                                        </td>
                                        <td>
