...
<body class="mobile">
    ...
    margin-bottom: 17px;">
            <div class="brand">
                ...
                <span style="color: white;"><strong>Admin Restaurant</strong></span>
            </div>
            <div class="hamburger">
                <span></span>
                <span></span>
    ...
    @endif
            <ul class="nav-list">
                <li>
                    ...
                    <a href="{{route('ADM_RESTAURANT.unverifiedCltrestaurant')}}">Clients verifies</a>
                </li>
                <li><a href="{{route('ADM_RESTAURANT.unverifiedCltrestaurant')}}">Clients Non verifies</a></li>
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-body" id="clientsContainer">
                        ...
                        <form method="POST" action="{{route('restaurantsReservations.update')}}">
                            @csrf
                            @method('PUT')
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    @foreach($unverifiedRestaurantClients as $client)

                                    <tr>
                                        <input type="hidden" name="reservation_restaurant_id" value="{{ $client->id }}">
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" name="is_verified" value="1" {{ $client->isVerified ? 'checked' : '' }}>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
